...
function Nav({ onSearch }) {
  ...
  const openModal = () => {
    setInitialLocation(locationInput);
    setInitialGuests(guestsInput);
    setShowModal(true);
  };
  ...
  return (
    <div className="nav-container">
      <div className="nav">
        <div className="header mb-9 flex items-center justify-between">
        ...
        <div className="encabe-container ml-4 flex justify-between items-center">
          <h2 className="encabe font-bold text-2xl">Stays in Finland</h2>
          <p className="encajr w-[81px]">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="search-logo-container">
                  ...
                  <button
                    type="button"
                    onClick={resetValues}
                    className="w-full p-2 bg-gray-300 text-gray-700 rounded flex items-center justify-center"
                  >
                    Reset Values
                  </button>
                </div>
